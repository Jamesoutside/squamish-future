...
(function () {
  ...
  var css = `
    ...
    .sf-dropdown {
      ...
      border: 1px solid rgba(46,123,139,0.2);
      border-radius: 10px;
      padding: 0.4rem 0;
    ...
    .sf-dd-link:hover {
      background: rgba(46,123,139,0.09);
      color: white;
    }
    .sf-dd-icon {
      font-size: 1rem;
    ...
    @media (max-width: 900px) {
      ...
      .sf-nav-links.sf-open {
        ...
        height: auto;
        z-index: 9998;
        border-top: 1px solid rgba(46,123,139,0.15);
      }
      ...
      .sf-nav-links.sf-open .sf-dropdown {
        ...
        box-shadow: none;
        border: none;
        border-left: 2px solid rgba(46,123,139,0.25);
        margin-left: 1.2rem;
        border-radius: 0;
